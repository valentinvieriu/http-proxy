    ...
    BigText = {
      ...
      jQueryMethod: function(options)
      {
        ...
        options = $.extend({
          ...
          childSelector: '',
          /**
           * Customization for ds2 BMWST-980
           *
           * Set resize to false to stop the plugin itself listening to window
           * resize event and behaving oddly.
           * Instead we use our own listener and fire the plugin again if needed.
           */
          resize: false
        }, options || {});
