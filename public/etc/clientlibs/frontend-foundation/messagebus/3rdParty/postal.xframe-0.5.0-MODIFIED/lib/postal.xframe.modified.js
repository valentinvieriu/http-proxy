...
(function webpackUniversalModuleDefinition(root, factory) {
    /**
     * BMW modification:
     * This is the modification from origin request-response plugin. The original xframe plugin for
     * postal misses to declare the dependency to postal.federation. This modification 'patches' the
     * dependency blocks for the UMD-head of xframe.
     */
    if (typeof exports === 'object' && typeof module === 'object')
        module.exports = factory(require("lodash"), require("postal"), require("postal.federation"));
    else if (typeof define === 'function' && define.amd)
        define(["lodash", "postal", "postal.federation"], factory);
    else if (typeof exports === 'object')
        exports["postalXframe"] = factory(require("lodash"), require("postal"), require("postal.federation"));
    else
        root["postalXframe"] = factory(root["_"], root["postal"], root["postal.federation"]);
                        ...
                        send: {
                            value: function send(packingSlip) {
                                if (this.shouldProcess()) {
                                    ...
                                    if (typeof this.target.postMessage == 'function') { // check for safari HP-ALM #10615
                                    	if (!env.isWorker) {
                                        	if (args.length === 1) {
